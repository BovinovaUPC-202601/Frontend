...
export function AddCategoryDialog() {
    ...
    if (!isOpenModalCategory) return null;
            ...
            <div className="bg-white rounded-[20px] shadow-xl w-full max-w-lg mx-4 animate-fade-in">
                <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-[#E1E7DF]">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-lg font-bold text-[#0E1A12] font-inter">Registrar categoría</h2>
                    </div>
                ...
                <div className="px-6 py-5 flex flex-col gap-5">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            ...
                            onChange={(e) => { setValidationError(""); setNewCategory({ name: e.target.value }); }}
                        />
                    </div>
